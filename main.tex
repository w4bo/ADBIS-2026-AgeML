...
%
Algorithmic optimisation remains separate from \ac{LLM}-based reasoning to ensure reproducibility and controlled automation.
\malasidenote{quale algorithmic optimisation? immagino la parte di planning, ma non è chiaro}
%
...
\malasidenote{in realtà c'è comunque lo step di validate\_code\_compliance come anche in fig 3}
...
\malasidenote{forse è utile ribadire che viene fatto sul test-set}
%
...
\malasidenote{più che experimental `design' direi più `setup'}
