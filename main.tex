...
%
Out of the specification, a search space for pipeline generation is algorithmically constructed and explored to ensure reproducibility and controlled automation.
%
Then, \acp{LLM} operate within a controlled agent loop to interpret specifications, generate, validate, and produce structured explanations for generated pipelines.
%
...
\Cref{sec:conclusion} concludes the paper and discusses future works.
...
\texttt{budgets} defines execution budgets and resource limits for an automated search process, such as that at most 5 candidate pipelines may be evaluated and 10 number of attempts can be used to generate valid pipeline code.
...
along with specification and automation scripts for reproducing our experiments,
