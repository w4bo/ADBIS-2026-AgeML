...
\end{tabular}
\caption{
    Detailed comparison of recent \ac{AutoML} non-\ac{LLM} and \ac{LLM}-based approaches 
    by analyzing key features such as end-to-end pipeline construction, 
    human-centered design, 
    constrained generation of the pipelines, 
    pipeline validation and error checks, 
    interpretability, 
    and 
    cold-start capabilities 
    (i.e., the possibility to work without mandatory a-priori knowledge or external information).
}
