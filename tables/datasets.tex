...
\begin{table}[t]
    ...
    \caption{
        ...
        The datasets cover both classification (C) and regression (R) tasks and include a diverse set of domains such as remote sensing, human activity recognition, image classification, tabular census data, and structured regression problems.
